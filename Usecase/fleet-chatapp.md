...
7.  In Azure Data Factory, go to the **Author** tab (pencil icon on the left).Click **Pipeline-> New Pipeline**
...
9.  Click **Move and transform →** Drag **Copy data** action to the canvas 
...
11. Click on **Source** tab and select **New** next to **Source dataset** drop down.

![](./media/image48.png)

12. Search for **blob**, select **Azure blob storage** and click on **Continue**.
...
15. Double click on **fleetdata** folder and select **fleet_data.csv** file and then click on **Ok**.
...
17. Click on **Sink** tab and then click on **New** next to **Sink dataset** drop down.

![](./media/image56.png)

18. Search for +++postgresql+++ ,select **Azure Database for PostgreSQL** and click **Continue**.
...
25. Name the output stream – **datacleanpostsql** and select    **AzurePostgreSqlcontosofleettable** dataset
...
29. Scroll down and select **MeasurementTimestamp , fleetid and  truckid** column and then click on **Delete**.
...
31. Select the Derived Column option and enter Output steam name as – +++repalcenullvalues+++ and click on **Open expression builder** link

![](./media/image72.png)

32. Create/Enter column names and their **Expression** as per the below table
...
35. Enter the output steam name - +++filterrpm+++ and the expression -+++enginerpm>=500&&enginerpm<=6000+++
