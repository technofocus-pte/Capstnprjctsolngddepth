...
4.  **Click on Server parameters and seach for extensions. Select
    vector** and **azure-ai extensions** and then click on **Save**
...
8.  Enter the command then enter password for user citus as :
...
12. Create another table to export cleaned data –
    **Fleet-Clearned_data** table.
...
7.  In Azure Data Factory, go to the **Author** tab (pencil icon on the
    left).Click **Pipeline-\> New Pipeline**

![](./media/image44.png)

8.  Name it **IngestBlobToPostgreSQL**.

![](./media/image45.png)

9.  Click **Move and transform →** Drag **Copy data** action to the
    canvas 

![](./media/image46.png)

10. Enter **Copy data name**: **blobtopostgresql .**

![](./media/image47.png)

11. Click on **Source** tab and select **New** next to **Source
    dataset** drop down.

![](./media/image48.png)

12. Search for **blob**, select **Azure blob storage** and click on
    **Continue**.

![](./media/image49.png)

13. Select **Delimited Text** format and click **Continue**.

![](./media/image50.png)

14. Enter the name as **blobfleetdata**, select your blob linked service
    and then click drop down next to **File path** and select **From
    root.**

![](./media/image51.png)

15. Double click on **fleetdata** folder and select **fleet_data.csv**
...
17. Click on **Sink** tab and then click on **New** next to **Sink
    dataset** drop down.

![](./media/image56.png)

18. Search for **postgresql** ,select **Azure Database for PostgreSQL**
    and click **Continue**.

![](./media/image57.png)

19. Set below properties and then click on OK.
...
20. Click on **Mapping** tab.

![](./media/image59.png)

21. Click on **Import schema**

![](./media/image60.png)![A screenshot of a computer AI-generated
content may be incorrect.](./media/image61.png)

22. Add Data flow to the Copy data action. Select **Data Flow**
    ![](./media/image62.png)

23. Name the data flow - **Cleandataindataflow**

![](./media/image63.png)

24. Click on **Settings -\> New** next to **Data flow**.
...
25. Name the output stream – **datacleanpostsql** and select
    **AzurePostgreSqlcontosofleettable** dataset

![](./media/image66.png)

26. Turn on **Data flow debug** and click Ok.

![](./media/image67.png)

27. Select source action and click on + and click on **Select** action.

![](./media/image68.png)

28. Select the box and enter **Output steam name** as - **dropcolumns**.

![](./media/image69.png)

29. Scroll down and select **MeasurementTimestamp , fleetid, truckid**
    column and then click on **Delete**.

![](./media/image70.png)

30. Click on + next to the tile and select **Derived Column** option
    from the list.

![](./media/image71.png)

31. Select the Derived Column option and enter Output steam name as –
    **repalcenullvalues** and click on **Open expression builder** link

![](./media/image72.png)

32. Create/Enter column names and their **Expression** as per the below
    table
...
33. then click on **save and finish** button
...
34. Select **repalcenullvalue** action and add **Filter** under Row
    modifier section.

![](./media/image78.png)

35. Enter the output steam name - filterrpm and the expression -
    **enginerpm\>=500&&enginerpm\<=6000**

> ![](./media/image79.png)

36. Add another filter map

> ![](./media/image80.png)

37. Name the filter – **filtervehiclesensor** and add below expression

**vehiclespeedsensor \>= 0 && vehiclespeedsensor \<=200**

![](./media/image81.png)

38. Add **Sink** to the **filtervehiclesensor** map**.**

![](./media/image82.png)

39. Name -**tofleetcleanedtable** , add the description - export cleaned
    data to fleet_cleaned_data table and click on **New** next to
    **Dataset** dropdown

![](./media/image83.png)

40. Search for postgresql and select **Azure Database for PsotgreSQL**
    tile and then click on **Continue**.

![](./media/image84.png)

41. Enter below values and click on **OK**.
...
42. Click on **Validate all** and close the notification.
...
1.  Switch back to **Azure portal -\> Resource group** and select your
...
3.  Click on **Compute** from left navigation menu .Select the compute
    instance and select on **Notebook**.
...
23. Now Deploy the model as a web service .Run the cell. Deployment
...
4.  Select **Keys** form left navigation bar and select both option.
    Wait for the change to be successful.
...
1.  Click on **Search management -\>indexes** from left navigation and
    select **Add index -\> Add index**

![](./media/image141.png)

2.  Enter the index name as : **fleet_index** and click on **Add
    field.**
...
4.  Enter Dimensions as **1536** and then click on Create under **No
...
6.  Keep default values and then click on **Save** under **Vector
    algorithm**
...
3.  Click on **Deployments** from left navigation menu and select
    **Deploy model -\> Deploy base model.**

![](./media/image154.png)

4.  Search for **text-embedding-ada-002** model and select it and then
...
6.  Keep all the default values . **Increase Tokens per Minute Rate
    Limit to max tokens** and then click on **Deploy**.
...
1.  Click on **Deployments** from left navigation menu. Select **Deploy
    model -\> Deploy base model.**

![](./media/image159.png)

2.  Search for **gpt** model and select **gpt-35-turbo** ( any available
    chat model in resource region) and then click on **Confirm**.
...
1.  Switch back to Azure Machine learning studio and select
    **export_fleet_embeddings.ipynb**
...
4.  Update the environment variables with your azure resource values and
    then run to write values to .env values.
...
2.  Open visual Studio code from Dekstop. Click on **File-\> Open
    Folder.**
...
6.  Expand chatapp folder and update .env file with your azure resource
...
4.  Click on **Extensions** and search for **Azure App Service** and
    **install** it.
...
3.  Enter unique name (fleetguardXXXXX- XXXXX can be unique number)for
...
1.  Go to the **chatapp** folder , right click on the folder and select
    **Deploy to web app**.
...
3.  Select **Environment variables under Settings** from left navigation
...
8.  Click on **Configuration** and add startup command as - **python -m
...
11. Click on identity from left navigation menu, On the status and
    Save-\> Yes

> ![](./media/image227.png)

12. Click on **Authentication** form left navigation bar and select
    **Add identity provider.**

![](./media/image228.png)

13. Select below values and keep all default values and then click on
    **Next: Permissions.**
...
14. Click on Add permission. Expand Applicaions , select
    Application.ReadWrite.All Read and write all applications check box
